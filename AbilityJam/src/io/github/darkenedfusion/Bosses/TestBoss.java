package io.github.darkenedfusion.Bosses;
...
public class TestBoss extends EntityGiantZombie {
	...
	public TestBoss(Location loc) {
		...
		this.setCustomName(new ChatComponentText(
				ChatColor.translateAlternateColorCodes('&', "&8&lTest Boss")));
		...
		meta5.setDisplayName(ChatColor.RED + "Fire Blade");
